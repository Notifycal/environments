...
inputs = {
  base_domain   = dependency.url_registry.outputs.static_landing_url.base_domain
  domain_prefix = dependency.url_registry.outputs.static_landing_url.domain_prefix
}
