locals {
  ...
  # run_cmd will always run, regardless of condition. Uses the stack_version from env.json if isn't "latest" or ""
  resolved_stack_version = (contains(["", "latest", "main"], local.stack_version) ?
